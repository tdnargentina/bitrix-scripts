...
$description = "Была удалена сделка ID: $dealdata пожалуйста, перейдите в корзину и посмотрите кто удалил и выясните причину удаления (задача создана данным вебхуком https://enterprisesubscription.bitrix24.com/devops/edit/out-hook/19/)";
$resoinsible = 17;
$deadline = "2025/08/25";
